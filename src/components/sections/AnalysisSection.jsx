...
const AnalysisSection = () => {
    ...
    return (
        <section id="analysis" className="relative py-40 px-6 bg-[#D8CBF0]">
            <div className="absolute bottom-1/3 left-1/4 w-[500px] h-[500px] rounded-full bg-violet-400/10 blur-3xl pointer-events-none" />
